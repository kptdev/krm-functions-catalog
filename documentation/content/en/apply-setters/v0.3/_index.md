...
```shell
$ kpt fn eval --image ghcr.io/kptdev/krm-functions-catalog/apply-setters:v0.3 --fn-config ./apply-setters-fn-config
```

Alternatively, setter values can be passed as key-value pairs in the CLI

```shell
$ kpt fn eval --image ghcr.io/kptdev/krm-functions-catalog/apply-setters:v0.3 -- tag=1.16.2 nginx-replicas=3
```
