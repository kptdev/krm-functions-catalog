...
linkTitle: "delete-annotations"
tags: "mutator"
weight: 4
description: |
  Deletes the provided annotations on resources.
menu:
  main:
    parent: "Function Catalog"
---
<!-- DO NOT EDIT: generated from functions/go/delete-annotations/README.md and metadata.yaml -->
{{< listversions >}}
...
```shell
$ kpt fn eval -i ghcr.io/kptdev/krm-functions-catalog/delete-annotations:v0.1 -- annotationKeys=annotation-to-delete,another-annotation-to-delete
```
...
pipeline:
  mutators:
    - image: ghcr.io/kptdev/krm-functions-catalog/delete-annotations:v0.1
      configMap:
