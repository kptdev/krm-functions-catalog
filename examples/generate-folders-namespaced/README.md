...
---
# generate-folders: Namespaced Example
...
```shell
kpt pkg get https://github.com/kptdev/krm-functions-catalog/tree/master/examples/generate-folders-namespaced
```

### Function invocation

```shell
kpt fn render generate-folders-namespaced
```
